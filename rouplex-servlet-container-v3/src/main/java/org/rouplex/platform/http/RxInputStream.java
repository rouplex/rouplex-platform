...
import org.rouplex.platform.io.RxReadChannel;
...
class RxInputStream extends ServletInputStream {
    ...
    private final RxReadChannel reactiveReadChannel;
    ...
    RxInputStream(ByteBuffer buffered, RxReadChannel reactiveReadChannel) {
